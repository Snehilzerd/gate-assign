...
In every group of 5, evaluating probability of every case
\begin{table}[h]
\def\arraystretch{1.2}
\begin{tabular}{|c|c|c|}
\hline
	...
	5 negaive &$^{5}C_{0}(0.9)^{5}$ &0.5904 \\ \hline
\end{tabular}
\end{table}
\begin{align}
P_{(of a group testing positive)} &= 0.00001 + 0.00045 + 0.0081 + 0.0729 + 0.32805 
\\ &= 0.4096
\end{align}
